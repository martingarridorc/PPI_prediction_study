...
class ProteinSequenceInteractionDataset(data.Dataset):
    ...
    def __init__(self, datafile, max_size):
        ...
        if ',' in datafile:
            ...
            sep = ' '
        self.dataframe = pnd.read_csv(datafile, sep, names=['index', 'Protein1', 'Protein2','HasInteraction', 'Sequence1', 'Sequence2'])
    ...
    def __getitem__(self, index):
        ...
        seq1 = d.sequence_to_vector(data[4])
        seq2 = d.sequence_to_vector(data[5])
